...
namespace Fiscal.Properties {
    public class ClassContabilista 
    ...
    public class ClassContabilistaEntityTypeConfiguration : IEntityTypeConfiguration<ClassContabilista> {
        public void Configure(EntityTypeBuilder<ClassContabilista> builder) {
