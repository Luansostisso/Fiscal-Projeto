...
namespace Fiscal.Properties {
    ...
    public class ClassEmitenteEntityTypeConfiguration : IEntityTypeConfiguration<ClassEmitente> {
        public void Configure(EntityTypeBuilder<ClassEmitente> builder) {
