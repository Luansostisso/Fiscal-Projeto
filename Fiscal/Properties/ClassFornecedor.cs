...
namespace Fiscal.Properties {
    ...
    public class ClassFornecedorEntityTypeConfiguration : IEntityTypeConfiguration<ClassFornecedor> {
        public void Configure(EntityTypeBuilder<ClassFornecedor> builder) {
