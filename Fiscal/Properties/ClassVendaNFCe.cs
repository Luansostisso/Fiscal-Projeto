...
namespace Fiscal.Properties {
    ...
    public class ClassVendaNFCeEntityTypeConfiguration : IEntityTypeConfiguration<ClassVendaNFCe> {
        public void Configure(EntityTypeBuilder<ClassVendaNFCe> builder) {
